                  ...
                  <div className="flex flex-col items-center relative">
                    <div className="w-full  ">
                      <div className=" p-1 flex border border-gray-700 bg-gray-800 rounded ">
                        <div className="flex flex-auto flex-wrap w-1/5">
                          {currentSelection
                            ? getAllSelected().map((opt, index): any => {
                                return (
                                  <div key={index} className="w-auto flex items-center bg-gray-700 rounded-full mr-1 mb-1 border border-gray-700 text-white focus:outline-none focus:border-indigo-500 text-base px-4 py-2 hover:border-grey shadow">
