				...
				<div>
					...
					<div id="profile" className="rounded-lg shadow-2xl bg-gray-800 -m-12">
						<div
							...
							<div
								className="w-full h-auto flex flex-col md:flex-row h-8 text-white pt-1 pl-1 text-base justify-center">
								{getPermissionsView()}
							</div>
						</div>
        ...
        <div>
          ...
          <div id="profile" className="rounded-lg shadow-2xl bg-gray-800 -m-12">
            <div className="p-4 md:p-12 text-center lg:text-left bg-gray-800 rounded-lg border-teal border-t-12 shadow-lg">
              ...
              <div className="w-full h-auto flex flex-col md:flex-row flex-wrap text-white pt-1 pl-1 text-base justify-center">
                { getPermissionsView() }
              </div>
            </div>
            <div className="inset-x-0.bottom-0 flex justify-around pt-4 pb-4">
