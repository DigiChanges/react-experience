	...
	<section className="text-gray-500 body-font bg-gray-900">
		<div className="container px-5 py-24 mx-auto">
			<div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
				<Title titleType="h2" className="sm:text-3xl text-2xl font-medium title-font mb-2 text-white">
			...
			<div className="flex flex-wrap -m-4">
				<div className="xl:w-1/3 md:w-1/2 p-4">
					<div className="border border-gray-800 p-6 rounded-lg">
						...
						<Title titleType="h2" className="text-lg text-white font-medium title-font mb-2">
							Shooting Stars
						</Title>
