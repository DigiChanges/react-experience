...
{   
    ...
    return (
        <>
            <div className="w-3/4 flex flex-col justify-center items-center h-auto mx-auto">
                <div className='z-10'>
                  <AvatarImage avatar={'/userAvatar.jpg'} image={props.image} alt={'avatar user'} className={'w-32 h-32 rounded-full object-cover shadow-kx1'}/>
                </div>
                <div id="profile" className="rounded-lg shadow-2xl bg-gray-800 -m-12">
                    <div className="p-4 md:p-12 text-center lg:text-left bg-gray-800 rounded-lg border-teal border-t-12 shadow-lg">
                        <div className='flex justify-center items-center relative'>
                            <h1 className="text-3xl font-bold text-white text-center pt-1">Jeremias David Koch</h1>
                        ...
                        <div className="w-full flex h-8 text-white pt-1 pl-1 text-base justify-center">
                            {roles.length > 0 ?
                             roles.map((rol, index) => {
                             return <span key={index} className='w-auto flex items-center bg-gray-700 rounded-lg mr-1 mb-1 border border-gray-700 text-white focus:outline-none focus:border-indigo-500 text-base px-4 py-2 hover:border-grey shadow"'>{rol}</span>
                             })
