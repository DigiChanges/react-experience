    ...
    <section>
      ...
      <div className="text-gray-500 bg-gray-900 flex flex-row items-center flex-wrap w-full justify-start">
        {usersList && usersList.map((user, i) => (
          <MediaObject key={i} className="md:max-w-md w-full md:w-1/2 p-2 bg-main-gray-600 h-18 rounded-lg mx-1 my-1 flex items-center font-semibold text-sm text-main-gray-250">
