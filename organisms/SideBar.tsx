  ...
  return (
    <div className={className}>
      <div className="flex flex-row md:flex-col w-full h-full rounded-r-3xl overflow-hidden">
        ...
        <ul className="flex flex-row md:flex-col pt-6 pb-6 pl-6 items-center h-full justify-end md:items-start md:justify-center w-full">
          <li className="flex justify-end w-full pr-6 pb-2">
            <div className="flex flex-row justify-end w-6 text-main-gray-300 cursor-pointer" >
              <IconArrowCircleLeft />
            </div>
          </li>
          {getDashRoutes()}
