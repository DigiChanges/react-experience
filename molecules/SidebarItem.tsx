...
const SideBarItem = ({theKey, name, path, icon, levels, user, userPermissions, isLoading}) =>
{
			...
			{multi ? (
				<div>
					<a onClick={toggleMenu}
					   className="w-full flex flex-row items-center justify-center md:justify-start h-12 transform hover:translate-y-2 hover:translate-x-0 md:hover:translate-x-2 md:hover:translate-y-0 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800 cursor-pointer">
						{(Icon ?
              ...
              +
				...
				<Link href={path} key={theKey}>
					<a className="flex flex-row items-center justify-center md:justify-start h-12 transform hover:translate-y-2 hover:translate-x-0 md:hover:translate-x-2 md:hover:translate-y-0 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
						{(Icon ?
							<span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400">
            <Icon size={size} color={color}/>
          </span> : <span className="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"/>)}
